...
const DesktopFilter = ({ handleChange, filters }) => {
  return (
        ...
        <div className="bg-white">
          <div className="mx-auto max-w-2xl px-4 py-0 sm:px-6 sm:py-0 lg:max-w-7xl lg:px-8">
            <Link
              ...
              className="px-4 bg-green-700 hover:bg-green-600 font-semibold text-white rounded-md mt-2 py-[2px]"
            >
              Add product
            </Link>
            <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-2 xl:gap-x-8">
              {products.map((product) => (
                <div
                  key={product.id}
                  className="border-solid border-2 rounded-md pb-2"
                >
                  <Link
                    ...
                    <div className="mt-4 px-2 flex justify-between">
                      <div>
                        ...
                        <p className="mt-1 text-sm text-gray-500 flex items-center">
                          <StarIcon className="h-5 w-5 inline mr-[3px]" />
                  ...
                  <Link
                    ...
                    className="px-4 bg-indigo-600 text-white rounded-sm ml-2 mt-2 py-[2px]"
                  >
                    Edit
                  </Link>
                </div>
